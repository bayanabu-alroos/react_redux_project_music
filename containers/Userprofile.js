...
{/* Phone */}              
              <div className="row mb-3">
                ...
                <div className="col-sm-9 text-secondary">
                  <input type="tel"  required name="phone"  className="form-control"   placeholder={userInfo.mobile}  onChange={handleChange}/>
                </div>
              </div>
              ...
              <div className="row mb-3">
                ...
                <div className="col-sm-9 text-secondary">
                  <input type="text"  required name="pass"  className="form-control"   placeholder={userInfo.pass}  onChange={handleChange}/>
                </div>
              </div>
